...
// if the value is unrecognized. Supports #RGB, #RRGGBB, and CSS named colors.
...
func parseHexColor(s string) color.Color {
	...
	case 4: // #RGB
		...
		return color.RGBA{R: r * 17, G: g * 17, B: b * 17, A: 0xff}
	case 7: // #RRGGBB
		r1, ok1 := hexByte(s[1])
		r2, ok2 := hexByte(s[2])
		g1, ok3 := hexByte(s[3])
		...
		return color.RGBA{R: r1<<4 | r2, G: g1<<4 | g2, B: b1<<4 | b2, A: 0xff}
	}
	return nil
}
...
// cssNamedColors is the full W3C CSS Color Level 4 named color table.
