...
func TestTextTransform(t *testing.T) {
	runCases(t, []renderCase{
		...
		{name: "table cell uppercase", html: `<table style="border-spacing:0"><tr><td style="text-transform:uppercase;width:5">hello</td></tr></table>`, want: "HELLO\n"},
		{name: "table cell capitalize", html: `<table style="border-spacing:0"><tr><td style="text-transform:capitalize;width:11">hello world</td></tr></table>`, want: "Hello World\n"},
...
func TestFontVariant(t *testing.T) {
	runCases(t, []renderCase{
		...
		{name: "small-caps in table cell", html: `<table style="border-spacing:0"><tr><td style="font-variant:small-caps;width:5">hello</td></tr></table>`, want: "HELLO\n"},
	})
}
