...
func TestSelectors(t *testing.T) {
	runCases(t, []renderCase{
		...
		{name: ":checked matches an input with the checked attribute", css: `input:checked { display: none; }`, html: `<input type="checkbox" checked><input type="checkbox">`, want: "☐"},
		{name: ":checked does not match an unchecked input", css: `input:checked { display: none; }`, html: `<input type="checkbox">`, want: "☐"},
		{name: ":disabled matches an input with the disabled attribute", css: `input:disabled { display: none; }`, html: `<input value="a" disabled><input value="b">`, want: "[b]"},
