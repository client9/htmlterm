...
// or Loop.SetTimeout, for later cancellation via ClearInterval or
// ClearTimeout.
...
// Screen.PostEvent) when a registered timer's ticker or timer fires. It is
// just
...
// stopAllTimers cancels every still-registered timer. It is called by Run
...
// stale, meaning already canceled, rather than a bug: the forwarding
// goroutine may
